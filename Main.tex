...
% if you use Mendeley, point the bibtex output at the 'skeleton' folder and change the MasterRef file to whatever mendeley outputs for you
\bibliography{skeleton/MasterRef}
\endgroup
